...
**Why am I unable to set guifont in _vmrc?**  Settings such as guifont can be set multiple times.  Only the last one is used.  Check to make sure isn't not being set in multiple rc files.
